...
namespace pickpoint_delivery_service
{
    public class DeliveryDbContextInitiallizer : IDeliveryDbContextInitiallizer
    {
        ...
        public int InitProducts(DeliveryDbContext context, string contentPath= @"D:\System-Config\MyExpirience\Console_BlazorAPp\Console_BlazorApp\")
        {
            if (context.Products.Count() > 0)
                return 0;
            string ResourceDir = $"{contentPath}" + @"\wwwroot\Resources";
            ...
            PostSparePartsOfferResponse offer = new PostSparePartsOfferResponse()
            {
                Offer_lines =Newtonsoft.Json.JsonConvert.DeserializeObject<List<PostSparePartsOfferResponseItem>>(@" [
                    ...
                    {
                      ""product_id"": ""0-0-4069344-0"",
                      ""price"": 230,
                      ""quantity"": 47
                    },
                    {
                      ""product_id"": ""0-0-1799621-0"",
                      ""price"": 250,
                      ""quantity"": 48
                    },
                    {
                      ""product_id"": ""0-0-5362-0"",
                      ""price"": 330,
                      ""quantity"": 83
                    },
                    {
                    ...
                    {
                      ""product_id"": ""0-0-35397-0"",
                      ""price"": 400,
                      ""quantity"": 5
                    },
                    {
                      ""product_id"": ""0-0-49968-0"",
                      ""price"": 410,
                      ""quantity"": 3
                    },
                    {
                      ""product_id"": ""0-0-3037321-0"",
                      ""price"": 540,
                      ""quantity"": 1
                    },
                    {
                      ""product_id"": ""0-0-5830474-0"",
                      ""price"": 640,
                      ""quantity"": 5
                    }
            ...
            offer.Offer_lines.AddRange(client.OfferAsync(new()
            {
                City_id = "1",
                Demand_price_percent_filter = 0,
                Max_offer_count = 10,
                Manufacturer = "Metalcaucho",
                Oem = "03598"
            }).Result.Offer_lines.ToList());
            ...
            foreach(var product in offer.Offer_lines)//new List<PostSparePartsOfferResponseItem>() { offer.Offer_lines.ToList()[0] , offer.Offer_lines.ToList()[1] })
            {
                ...
                var item = spare.PartAsync(product.Product_id).Result;
