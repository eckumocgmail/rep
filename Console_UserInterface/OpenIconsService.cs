...
/// <summary>
/// Выбор иконок OpenIcons/
/// Необходимо проверить подклюдключены ли статические ресурсы и записать шаблон
/// </summary>
public class OpenIconsService
{
...
public static class OpenIconsServiceExtension
{
    public static IServiceCollection AddOpenIcons(this IServiceCollection services)
    {
